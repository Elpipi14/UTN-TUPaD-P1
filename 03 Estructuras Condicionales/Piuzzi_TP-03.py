...
# Se convierte el input a número entero
# edad = int(input("Ingrese su edad: "));

# Si es 18 o más, es mayor de edad
# if edad >= 18:
...
# Se toma la nota como entero
# nota = int(input("Ingrese su nota: "));

# Aprobado si es 6 o más
# if nota >= 6:
#     print("Aprobado");
# else:
#     print("Desaprobado");
...
# Se usa float para permitir decimales
...
# Se agrupa la fecha como una tupla para comparar fácilmente
# fecha = (mes, dia);
...
# Comparación según la fecha y hemisferio
