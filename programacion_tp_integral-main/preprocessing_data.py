...
def preprocessing_data(path_data='data/data.csv'):
    ...
    logging.info("Normalizando la columna 'hour_dt'...")
    df['hour_dt'] = df['datetime_now'].dt.floor('h')

    # --- Se elimina el filtrado de franjas representativas por canal ---

    # Creando columnas de fecha, hora y día de la semana
